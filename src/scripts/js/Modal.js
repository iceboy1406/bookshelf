...
class Modal {
    ...
    constructor(name, id) {
        ...
        this.#id = id;
        this.#init();
        this.#cancelButton = this.#modalContainer.querySelector('button#cancel-button');
        ...
        this.#finishedReadCheckbox = this.#modalContainer.querySelector('#finished-read-checkbox');
    }
    #init() {
        switch (this.#name) {
            case 'AddBook':
    ...
    #initEditBookModal() {
      ...
      <form>
        <div class="input-group">
          ...
          <input type="text" id="title-field" placeholder="Masukan judul buku" value="${currentBook.title}" required autofocus>
        </div>
        <div class="input-group">
          <label for="author-field">Penulis</label>
          <input type="text" id="author-field" placeholder="Masukan penulis buku" value="${currentBook.author}" required>
        </div>
        <div class="input-group">
          <label for="year-field">Tahun Terbit</label>
          <input type="number" id="year-field" placeholder="Masukan tahun terbit buku" value="${currentBook.year}" required>
        </div>
        <div class="checkbox-group">
          <label>
            <input type="checkbox" name="finished-read" id="finished-read-checkbox" ${currentBook.isComplete ? 'checked' : ''}>
            <div class="checkbox">
    ...
    #initMarkConfirmationModal() {
      ...
      <div class="modal mark-confirmation">
        <h1 class="message">Apakah anda yakin ingin memindahkan buku ${book.title} ke rak ${book.isComplete ? 'Belum Selesai Dibaca' : 'Selesai Dibaca'}?</h1>
        <form>
          <button class="button button-secondary" id="cancel-button" type="button">Batal</button>
